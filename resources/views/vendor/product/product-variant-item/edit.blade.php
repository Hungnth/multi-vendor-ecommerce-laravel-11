        ...
        <div class="container-fluid">
            ...
            <div class="row">
                <div class="col-xl-9 col-xxl-10 col-lg-9 ms-auto">
                      <a href="{{ route('vendor.products-variant-item.index', ['product_id' => $variant_item->product_variant->product_id, 'variant_id' => $variant_item->product_variant_id]) }}" class="btn btn-warning mb-4"><i
                    ...
                    <div class="dashboard_content mt-2 mt-md-0">
                        ...
                        <div class="wsus__dashboard_profile">
                            <div class="wsus__dash_pro_area">
                                <form action="{{ route('vendor.products-variant-item.update', $variant_item->id) }}" method="POST">
                                    @csrf
                                    @method('PUT')

                                ...
                                <div class="">
                                    <div class="wsus__invoice_area">
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-xl-4 col-md-4">
                                                        <div class="wsus__invoice_single text-md-end">
                                                            ...
                                                            <h6>Order
                                                                Status: {{ config('order_status.order_status_admin')[$order->order_status]['status'] }}</h6>
                                                            <p>Payment Method: {{ $order->payment_method }}</p>
                                                            <p>Payment Status: {{ $order->payment_status }}</p>
                                                            <p>Transaction ID:
                                                                #{{ $order->transaction->transaction_id }}</p>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                        ...
                                        <div class="wsus__invoice_footer">
                                            ...
                                            <p><span>Total Amount:</span> <strong>{{ $settings->currency_icon }}{{ $order->amount }}</strong></p>
                                        </div>
                                    </div>
                                </div>
                            </section>
